/*amd /page/P00005.xml 17446 a463e54a34011f385e779273749a63310b009feded4bd194d41d07c793f3df8e */
define({declaration:{A:{version:'1.0',encoding:'UTF-8'}},E:[{T:1,N:'html',A:{xmlns:'http://www.w3.org/1999/xhtml','xmlns:ev':'http://www.w3.org/2001/xml-events','xmlns:w2':'http://www.inswave.com/websquare','xmlns:xf':'http://www.w3.org/2002/xforms'},E:[{T:1,N:'head',A:{},E:[{T:1,N:'w2:historyInfo',E:[{T:1,N:'w2:history',A:{}}]},{T:1,N:'w2:type',E:[{T:3,text:'COMPONENT'}]},{T:1,N:'w2:buildDate'},{T:1,N:'w2:MSA'},{T:1,N:'xf:model',E:[{T:1,N:'w2:dataCollection',A:{baseNode:'map'},E:[{T:1,N:'w2:dataMap',A:{baseNode:'map',id:'dma_request',style:''},E:[{T:1,N:'w2:keyInfo',E:[{T:1,N:'w2:key',A:{id:'reqData1',name:'전송값1',dataType:'text'}},{T:1,N:'w2:key',A:{id:'reqData2',name:'전송값2',dataType:'text'}},{T:1,N:'w2:key',A:{id:'reqData3',name:'전송값3',dataType:'text'}},{T:1,N:'w2:key',A:{id:'reqData4',name:'전송값4',dataType:'text'}}]}]},{T:1,N:'w2:dataMap',A:{id:'dc_resUserMapData',style:'',valueAttribute:''},E:[{T:1,N:'w2:keyInfo',E:[{T:1,N:'w2:key',A:{id:'name',name:'name',dataType:'text'}},{T:1,N:'w2:key',A:{id:'birthday',name:'birthday',dataType:'text'}},{T:1,N:'w2:key',A:{id:'height',name:'height',dataType:'text'}},{T:1,N:'w2:key',A:{id:'weight',name:'weight',dataType:'text'}},{T:1,N:'w2:key',A:{id:'gender',name:'gender',dataType:'text'}}]}]}]},{T:1,N:'xf:submission',A:{id:'sbm_getUserData',ref:'data:json,dma_request',target:'data:json,dc_resUserMapData',action:'/data/sampleData/sampleData_json_dc_map.json',method:'post',mediatype:'application/json',encoding:'UTF-8',mode:'asynchronous',processMsg:'','ev:submit':'scwin.sbm_getUserData_submit','ev:submitdone':'scwin.sbm_getUserData_submitdone','ev:submiterror':'scwin.sbm_getUserData_submiterror',instance:'',replace:'',errorHandler:'',customHandler:'',abortTrigger:''}},{T:1,N:'xf:submission',A:{id:'sbm_getUserData_404',ref:'data:json,dma_request',target:'data:json,dc_resUserMapData',action:'/sp5555/data/sampleData/sampleData_json_dc_map.json',method:'post',mediatype:'application/json',encoding:'UTF-8',mode:'asynchronous',processMsg:'','ev:submit':'scwin.sbm_getUserData_submit','ev:submitdone':'scwin.sbm_getUserData_submitdone','ev:submiterror':'scwin.sbm_getUserData_submiterror',instance:'',replace:'',errorHandler:'',customHandler:'',abortTrigger:''}},{T:1,N:'w2:workflowCollection'}]},{T:1,N:'w2:layoutInfo'},{T:1,N:'w2:publicInfo',A:{method:''}},{T:1,N:'script',A:{lazy:'false',type:'text/javascript'},E:[{T:4,cdata:function(scopeObj){with(scopeObj){
