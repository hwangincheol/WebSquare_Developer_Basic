/*amd /page/P00219.xml 6678 b7c106cb20d5f99089521554df9e2fbacd2d0ecc0d3d04e495d4893064b78f1c */
...
scwin.grd_exam1_oncontextopen = function (rowIndex, colIndex, arrJsnFocusedCell, jsnHeaderInfo) {
    ...
    if (rowIndex == -1) {
        ...
        switch (jsnHeaderInfo.headerId) {
            case "_headerRowNumber": //컬럼 rowNum
                console.log("header rowNum");
                break;
            case "_headerRowStatus": //컬럼 rowStatus
