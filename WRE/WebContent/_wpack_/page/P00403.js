/*amd /page/P00403.xml 4982 b349e3b247a0a294b14854cbd0dcacd0003f621124aa74b2632fcc6e6b8e37b0 */
...
}}}]}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload'},E:[{T:1,N:'xf:group',A:{class:'sub_contents',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'ws_example_grp_desc',id:'',style:''},E:[{T:1,N:'w2:textbox',A:{escape:'false',id:'',label:'날짜(yyyyMMdd) 형식의 문자열을 양력 날짜로 변환하는예제입니다.<br/>이 기능은 함수 \'WebSquare.date.toSolar\'를 사용하여 구현할 수 있습니다.',style:''}},{T:1,N:'w2:textbox',A:{class:'',escape:'false',label:'음력 날짜로 변환하는 경우 함수 \'WebSquare.date.toLunar\'로 구현할 수 있습니다.',style:''}},{T:1,N:'w2:textbox',A:{class:'exam_txt req_version',escape:'false',label:'\'WebSquare.date.toSolar\'는 아래의 엔진부터 제공됩니다.<br/>- RC: 5.0_5.4774B.20221202.165615<br/>- GA: 5.0_5.4877A.20230405.131227',style:''}}]},{T:1,N:'xf:group',A:{class:'example_div_tb_style_wrap',id:''},E:[{T:1,N:'xf:group',A:{class:'example_div_tr_style',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'example_div_td_style',id:'',style:''},E:[{T:1,N:'w2:textbox',A:{class:'ws5_example_txt_normal',escape:'false',id:'',label:'버튼을 클릭하면 InputCalendar에 입력된 값이 양력으로 변환되어 \'실행 결과\'에 출력됩니다.',style:''}},{T:1,N:'xf:group',A:{class:'no_bottom',id:'',style:''},E:[{T:1,N:'w2:inputCalendar',A:{calendarValueType:'yearMonthDate',class:'mr_def',focusOnDateSelect:'false',id:'ica_exam_1',minYear:'1900',renderDiv:'true',rightAlign:'false',style:'width:100px;','ev:onviewchange':'scwin.ica_exam_1_onviewchange',maxYear:'2100'}},{T:1,N:'xf:trigger',A:{class:'btn_exam_exec',disabled:'',escape:'false','ev:onclick':'scwin.btn_ex1_1_onclick',id:'btn_exam1',style:'',type:'button'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'양력으로 반환받기'}]}]}]},{T:1,N:'xf:group',A:{class:'no_bottom ws5_example_txt_normal',style:''},E:[{T:1,N:'w2:span',A:{class:'txt_bold mr_def',label:'실행 결과:',style:'display: inline-block;min-width:12px;line-height: 1.5em;'}},{T:1,N:'w2:span',A:{class:'',dataType:'text',label:'결과 값 출력 영역',style:'display: inline-block;min-width:60px;line-height: 1.5em;',id:'txt_result1'}}]}]}]}]}]}]}]}]})